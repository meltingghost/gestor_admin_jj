...
<i class="fa-solid fa-clipboard-check"></i> lista checkbox
...
<i class="fa-solid fa-pen-to-square"></i> pen 
<i class="fa-regular fa-pen-to-square"></i> pen
...
<i class="fa-solid fa-user-graduate"></i> user graduado
...
<i class="fa-solid fa-delete-left"></i> x
