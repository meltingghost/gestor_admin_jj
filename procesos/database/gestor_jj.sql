...
CREATE TABLE IF NOT EXISTS `gestor_jj`.`usuarios` ( 
	...
	PRIMARY KEY (`username`), UNIQUE (`id_usuario`)) 
	ENGINE = InnoDB DEFAULT CHARSET=utf8;

-- CREACIÓN DE LA TABLA CARGOS
CREATE TABLE IF NOT EXISTS `gestor_jj`.`cargos` ( 
	`id_cargo` INT NOT NULL AUTO_INCREMENT , 
	`nombreCargo` CHAR(255) NOT NULL , 
	`fecha` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , 
	PRIMARY KEY (`id_cargo`), UNIQUE (`nombreCargo`)) 
	ENGINE = InnoDB DEFAULT CHARSET=utf8;

-- VOLCADO DE DATOS
INSERT INTO `cargos`(`id_cargo`, `nombreCargo`, `fecha`) VALUES 
	(NULL,"Director",NULL), 
	(NULL,"Sub-director Administrativo",NULL), 
	(NULL,"Sub-director Académico",NULL);

-- CREACIÓN DE LA REALACIÓN ENTRE LAS TABLAS CARGOS Y USUARIOS
...
CREATE TABLE IF NOT EXISTS `gestor_jj`.`literal` ( 
	`id_literal` INT NOT NULL AUTO_INCREMENT , 
	`letraLiteral` CHAR(255) NOT NULL , 
	`descripcionLiteral` CHAR(255) NOT NULL , 
	`fecha` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , 
	PRIMARY KEY (`id_literal`), UNIQUE (`letraLiteral`)) 
	ENGINE = InnoDB DEFAULT CHARSET=utf8;

-- CREACIÓN DE LA TABLA CÓDIGOS
CREATE TABLE IF NOT EXISTS `gestor_jj`.`codigos` ( 
	`id_codigo` INT NOT NULL AUTO_INCREMENT , 
	`codigo` CHAR(255) NOT NULL , 
	`fecha` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , 
	PRIMARY KEY (`id_codigo`), UNIQUE (`codigo`)) 
	ENGINE = InnoDB DEFAULT CHARSET=utf8;

-- CREACIÓN DE LA TABLA GRADOS
CREATE TABLE IF NOT EXISTS `gestor_jj`.`grados` ( 
	`id_grado` INT NOT NULL AUTO_INCREMENT , 
	`numeroGrado` CHAR(255) NOT NULL , 
	`fecha` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , 
	PRIMARY KEY (`id_grado`), UNIQUE (`numeroGrado`)) 
	ENGINE = InnoDB DEFAULT CHARSET=utf8;

-- CREACIÓN DE LA TABLA SECCIONES
CREATE TABLE IF NOT EXISTS `gestor_jj`.`secciones` ( 
...
-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS GRADOS Y SECCIONES
ALTER TABLE `secciones` 
	ADD CONSTRAINT `gradosSecciones` 
	FOREIGN KEY (`id_grado`) 
	REFERENCES `grados`(`id_grado`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA TABLA AÑO ESCOLAR
CREATE TABLE IF NOT EXISTS `gestor_jj`.`anio_escolar` ( 
	`id_anioEscolar` INT NOT NULL AUTO_INCREMENT , 
	`ddmmi` CHAR(255) NOT NULL , 
	`yyi` CHAR(255) NOT NULL , 
	`ddmmf` CHAR(255) NOT NULL , 
	`yyf` CHAR(255) NOT NULL , 
	`fecha` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , 
	PRIMARY KEY (`id_anioEscolar`), UNIQUE (`yyf`, `yyi`)) 
	ENGINE = InnoDB DEFAULT CHARSET=utf8;

-- CREACIÓN DE LA TABLA PERMISOS
CREATE TABLE IF NOT EXISTS `gestor_jj`.`permisos` ( 
	`id_permiso` INT NOT NULL AUTO_INCREMENT , 
	`nombrePermiso` CHAR(255) NOT NULL , 
	`descripcionPermiso` CHAR(255) NOT NULL , 
	`fecha` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , 
	PRIMARY KEY (`id_permiso`), UNIQUE (`nombrePermiso`)) 
	ENGINE = InnoDB DEFAULT CHARSET=utf8;

-- CREACIÓN DE LA TABLA PERSONAL (PARTE 1)
CREATE TABLE IF NOT EXISTS `gestor_jj`.`personal_p1` (
  ...
  PRIMARY KEY (`id_personal`), UNIQUE (`cedulaPersonal`)) 
	ENGINE = InnoDB DEFAULT CHARSET=utf8;

-- CREACIÓN DE LA TABLA PERSONAL (PARTE 2)
CREATE TABLE IF NOT EXISTS `gestor_jj`.`personal_p2` (
  `id_personal` INT NOT NULL,
	`id_funcionPersonal` INT NOT NULL,
...
-- CREACIÓN DE LA RELACIÓN ENTRE LAS DOS PARTES DE LA TABLA PERSONAL
ALTER TABLE `personal_p2` 
	ADD CONSTRAINT `personalP2P1` 
	FOREIGN KEY (`id_personal`) 
	REFERENCES `personal_p1`(`id_personal`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS PERSONAL (PARTE 2) Y CARGOS
ALTER TABLE `personal_p2` 
	ADD CONSTRAINT `personalCargos` 
	FOREIGN KEY (`id_funcionPersonal`) 
	REFERENCES `cargos`(`id_cargo`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA TABLA ESTUDIANTES PARTE 1 (DATOS DEL ESTUDIANTE EI)
CREATE TABLE IF NOT EXISTS `gestor_jj`.`e_data_estudiante` (
	...
	`idEstadoNatalE` INT NOT NULL,
	`idMunicipioNatalE` INT NOT NULL,
	`idParroquiaNatalE` INT NOT NULL,
	`direccionHabitacionE` CHAR(255) NOT NULL,
	`sexoEB` CHAR(255) NOT NULL,
	`inscritoInicial` TINYINT NOT NULL,
	`fecha` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, 
	`papeleraE` TINYINT NOT NULL,
	`formalizado` TINYINT NOT NULL , 
	PRIMARY KEY (`id_estudiante`), UNIQUE (`cedulaE`)) 
	ENGINE = InnoDB DEFAULT CHARSET=utf8;

-- CREACIÓN DE LA TABLA ESTUDIANTES PARTE 2 (DATOS DE LOS PADRES EI)
CREATE TABLE IF NOT EXISTS `gestor_jj`.`e_data_padres_i` (
	...
	-- CREACIÓN DE LA TABLA ESTUDIANTES PARTE 3 (INFORMACIÓN DEL NIÑO EI)
CREATE TABLE IF NOT EXISTS `gestor_jj`.`e_data_familiar_i` (
	`id_estudiante` INT NOT NULL,
	`autorizacionFEI` TINYINT NOT NULL,
	`organismoAutorizacionFEI` CHAR(255) NOT NULL,
	`tieneHermanosEI` TINYINT NOT NULL,
...
-- CREACIÓN DE LA TABLA ESTUDIANTES PARTE 4 (OTROS DATOS DE INTERES EI)
CREATE TABLE IF NOT EXISTS `gestor_jj`.`e_data_interes_i` (
	`id_estudiante` INT NOT NULL,
...
-- CREACIÓN DE LA TABLA ESTUDIANTES PARTE 5 (DATOS REPRESENTANTE EB)
CREATE TABLE IF NOT EXISTS `gestor_jj`.`e_data_representante_b` (
	`id_estudiante` INT NOT NULL,
	...
	`id_personalResponsableEB` INT NOT NULL,
	`confirmResponsableInsEB` TINYINT NOT NULL,
	`observacionesEB` CHAR(255) NOT NULL,
	`fichaNumEB` INT(4) NOT NULL,
	UNIQUE (`id_estudiante`))
	ENGINE = InnoDB DEFAULT CHARSET=utf8;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS DE ESTUDIANTES (PARTE 2 Y 1)
ALTER TABLE `e_data_padres_i` 
	ADD CONSTRAINT `estudiante_padres` 
	FOREIGN KEY (`id_estudiante`) 
	REFERENCES `e_data_estudiante`(`id_estudiante`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS DE ESTUDIANTES (PARTE 3 Y 1)
ALTER TABLE `e_data_familiar_i` 
	ADD CONSTRAINT `estudiante_familiar` 
	FOREIGN KEY (`id_estudiante`) 
	REFERENCES `e_data_estudiante`(`id_estudiante`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS DE ESTUDIANTES (PARTE 4 Y 1)
ALTER TABLE `e_data_interes_i` 
	ADD CONSTRAINT `estudiante_interes` 
	FOREIGN KEY (`id_estudiante`) 
	REFERENCES `e_data_estudiante`(`id_estudiante`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS ESTUDIANTES (PARTE 5) Y PERSONAL (PARTE 1)
ALTER TABLE `e_data_representante_b` 
	ADD CONSTRAINT `representante_personal` 
	FOREIGN KEY (`id_personalResponsableEB`) 
	REFERENCES `personal_p1`(`id_personal`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA TABLA FORMALIZAR_INS_E (RELACIONARÁ LAS TABLAS ESTUDIANTES, ANIO_ESCOLAR, LITERAL, GRADOS Y SECCIONES)
CREATE TABLE IF NOT EXISTS `gestor_jj`.`formalizar_ins_e` ( 
	`id_tabla` INT NOT NULL AUTO_INCREMENT , 
	`id_estudiante` INT NOT NULL , 
	`id_anioEscolar` INT NOT NULL , 
	`id_literalGradoAnterior` INT NOT NULL , 
	`id_gradoCursar` INT NOT NULL , 
	`id_seccionGradoCursar` INT NOT NULL , 
	`confirmacionRE` TINYINT NOT NULL , 
	`fecha` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , 
	PRIMARY KEY (`id_tabla`)) 
	ENGINE = InnoDB;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS FORMALIZAR Y ESTUDIANTES (PARTE 1)
ALTER TABLE `formalizar_ins_e` 
	ADD CONSTRAINT `formalizar_estudiante` 
	FOREIGN KEY (`id_estudiante`) 
	REFERENCES `e_data_estudiante`(`id_estudiante`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS FORMALIZAR Y AÑO ESCOLAR
ALTER TABLE `formalizar_ins_e` 
	ADD CONSTRAINT `formalizar_anioEscolar` 
	FOREIGN KEY (`id_anioEscolar`) 
	REFERENCES `anio_escolar`(`id_anioEscolar`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS FORMALIZAR Y LITERAL
ALTER TABLE `formalizar_ins_e` 
	ADD CONSTRAINT `formalizar_literal` 
	FOREIGN KEY (`id_literalGradoAnterior`) 
	REFERENCES `literal`(`id_literal`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS FORMALIZAR Y GRADOS
ALTER TABLE `formalizar_ins_e` 
	ADD CONSTRAINT `formalizar_grados` 
	FOREIGN KEY (`id_gradoCursar`) 
	REFERENCES `grados`(`id_grado`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS FORMALIZAR Y SECCIONES
ALTER TABLE `formalizar_ins_e` 
	ADD CONSTRAINT `formalizar_secciones` 
	FOREIGN KEY (`id_seccionGradoCursar`) 
	REFERENCES `secciones`(`id_seccion`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA TABLA MATERIAS (PARA LA RULETA)
CREATE TABLE IF NOT EXISTS `gestor_jj`.`materias_ruleta` ( 
	`id_materia` INT NOT NULL AUTO_INCREMENT , 
	`nombreMateria` CHAR(255) NOT NULL , 
	`fecha` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , 
	PRIMARY KEY (`id_materia`), UNIQUE (`nombreMateria`)) 
	ENGINE = InnoDB;

-- CREACIÓN DE LA TABLA PREGUNTAS (PARA LA RULETA)
CREATE TABLE IF NOT EXISTS `gestor_jj`.`preguntas_ruleta` ( 
...
-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS MATERIAS Y PREGUNTAS (RULETA) 
ALTER TABLE `preguntas_ruleta` 
	ADD CONSTRAINT `pregunta_materia` 
	FOREIGN KEY (`materia`) 
	REFERENCES `materias_ruleta`(`nombreMateria`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA TABLA ASISTENCIAS
CREATE TABLE `gestor_jj`.`asistencias` ( 
	...
	`asistente` TINYINT NOT NULL , 
	`confirmarAsistencia` TINYINT NOT NULL , 
	PRIMARY KEY (`id_asistencia`)) 
	ENGINE = InnoDB;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS ASISTENCIAS Y PERSONAL
ALTER TABLE `asistencias` 
	ADD CONSTRAINT `asistenciasPersonal` 
	FOREIGN KEY (`cedulaPersonal`) 
	REFERENCES `personal_p1`(`cedulaPersonal`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA TABLA ASISTENCAS_PERMISOS (PARA RELACIONAR LAS DOS TABLAS CORRESPONDIENTES)
CREATE TABLE IF NOT EXISTS `gestor_jj`.`permisos_personal` ( 
	`id_permiso_personal` INT NOT NULL AUTO_INCREMENT , 
	...
	`observacion` CHAR(255) NOT NULL , 
	`fecha` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , 
	PRIMARY KEY (`id_permiso_personal`)) 
	ENGINE = InnoDB;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS PERMISOS_PERSONAL Y PERMISOS
ALTER TABLE `permisos_personal` 
	ADD CONSTRAINT `permisos_personal` 
	FOREIGN KEY (`id_permiso`) 
	REFERENCES `permisos`(`id_permiso`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS PERMISOS_PERSONAL Y PERSONAL
ALTER TABLE `permisos_personal` 
	ADD CONSTRAINT `personal_permisos` 
	FOREIGN KEY (`id_personal`) 
	REFERENCES `personal_p1`(`id_personal`) 
	ON DELETE CASCADE 
	ON UPDATE CASCADE;
...
CREATE TABLE IF NOT EXISTS `gestor_jj`.`paises` (
...
CREATE TABLE IF NOT EXISTS `gestor_jj`.`estados` (
...
CREATE TABLE IF NOT EXISTS `gestor_jj`.`municipios` (
...
CREATE TABLE IF NOT EXISTS `gestor_jj`.`parroquias` (
...
-- CREACIÓN DE LA RELACION ENTRE LAS TABLAS MUNICIPIOS Y ESTADOS
...
-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS PARROQUIAS Y MUNICIPIOS
...
-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS ESTUDIANTES Y ESTADOS
ALTER TABLE `e_data_estudiante` 
	ADD CONSTRAINT `estudiantesEstados` 
	FOREIGN KEY (`idEstadoNatalE`) 
	REFERENCES `estados`(`id_estado`) 
	ON DELETE CASCADE ON UPDATE CASCADE;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS ESTUDIANTES Y MUNICIPIOS
ALTER TABLE `e_data_estudiante` 
	ADD CONSTRAINT `estudiantesMunicipios` 
	FOREIGN KEY (`idMunicipioNatalE`) 
	REFERENCES `municipios`(`id_municipio`) 
	ON DELETE CASCADE ON UPDATE CASCADE;

-- CREACIÓN DE LA RELACIÓN ENTRE LAS TABLAS ESTUDIANTES Y PARROQUIAS
ALTER TABLE `e_data_estudiante` 
	ADD CONSTRAINT `estudiantesParroquias` 
	FOREIGN KEY (`idParroquiaNatalE`) 
