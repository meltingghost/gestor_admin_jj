    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Agregar Literal</h1>
            ...
            <div class="modal-body">
                ...
                <form id="formAgregarLiteral" method="POST" action="" autocomplete="off" onsubmit="return agregarLiteral()">
                    ...
                    <label for="letraLiteral">Letra:</label>
                    <input type="text" name="letraLiteral" id="letraLiteral" class="form-control input-no-space" pattern="[a-zA-Z]+" maxlength="1" required="" onkeyup="mayus(this.id, this.value);">
                    <br>
                    <label for="descripcionLiteral">Descripción:</label>
                    <textarea name="descripcionLiteral" id="descripcionLiteral" class="form-control" cols="30" rows="2" required="" onkeyup="mayus(this.id, this.value);"></textarea>
                    <br>
