    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header bg-warning">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Modifcar Cargo</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">

                <p><b>Aqui Podrá Modifcar el Cargo</b></p>
                ...
                <form id="formEditarCargo" method="POST" autocomplete="off" onsubmit="return modificarCargo()">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <label for="nombreCargoEdit">Nombre del Cargo:</label>
                            <input type="text" name="nombreCargoEdit" id="nombreCargoEdit" class="form-control" pattern="[a-zA-Z]+" required="" onkeyup="mayus(this.id, this.value);">
                        </div>
                    </div>
                    <br>
