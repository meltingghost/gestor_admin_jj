 				...
 				?>
 					...
 					<div class="h-100 p-5 text-white bg-jj rounded-5 formRegistroSm">
	 					<form id="formRegistrarCodigoInscripcion" method="POST" autocomplete="off" onsubmit="return agregarCodigoInscripcion()">
	 						<label for="codigo">Código:</label><br><br>
	 						<input type="text" name="codigo" id="codigo" class="form-control input-no-space" minlength="3" maxlength="30" required="" onkeyup="mayus(this.id, this.value);"><br>
